...
namespace Datos
{
    ...
    {
        public string bdLocal = @"packet size=4096; persist security info=True; Data Source=DESKTOP-V07K6Q6\JMACHUCA; Initial Catalog=proyecto; Integrated Security=SSPI; Timeout=300";
